...
namespace Infrastructure.Repositories
{
    public class UserEquityRepository : IUserEquityRepository
    {
        ...
        public async Task<DbResponse<List<UserEquityViewModel>>> GetUserEquities( int userId, DateTime fromDate, DateTime toDate, int equityType = (int)EquityType.Stocks, int page = 1, int pageSize = 10, string searchText = "", string sortOrder = "DESC", string sortField = "CreatedDate", bool isActive = true, bool isDeleted = false )
        {
            try
            {
